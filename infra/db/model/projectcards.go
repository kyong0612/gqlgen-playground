...
func (q projectcardQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Projectcard, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for projectcards")
	}
...
func (q projectcardQuery) All(ctx context.Context, exec boil.ContextExecutor) (ProjectcardSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Projectcard slice")
	}
...
func (q projectcardQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count projectcards rows")
	}
...
func (q projectcardQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if projectcards exists")
	}
...
func (o *Projectcard) SetProjectcardIssue(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Issue) error {
	...
	updateQuery := fmt.Sprintf(
		...
		strmangle.SetParamNames("\"", "\"", 1, []string{"issue"}),
...
func (o *Projectcard) SetProjectcardProject(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Project) error {
	...
	updateQuery := fmt.Sprintf(
		"UPDATE \"projectcards\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 1, []string{"project"}),
		strmangle.WhereClause("\"", "\"", 2, projectcardPrimaryKeyColumns),
	)
	values := []interface{}{related.ID, o.ID}
...
func FindProjectcard(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Projectcard, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"projectcards\" where \"id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from projectcards")
	}
...
func (o *Projectcard) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no projectcards provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into projectcards")
	}
...
func (o *Projectcard) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update projectcards, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"projectcards\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 1, wl),
			strmangle.WhereClause("\"", "\"", len(wl)+1, projectcardPrimaryKeyColumns),
		)
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update projectcards row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for projectcards")
	}
...
func (q projectcardQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for projectcards")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for projectcards")
	}
...
func (o ProjectcardSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"projectcards\" SET %s WHERE %s",
		...
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), len(colNames)+1, projectcardPrimaryKeyColumns, len(o)))
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in projectcard slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all projectcard")
	}
	return rowsAff, nil
}
...
func (o *Projectcard) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no projectcards provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert projectcards, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"projectcards\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert projectcards")
	}
...
func (o *Projectcard) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no Projectcard provided for delete")
	}
	...
	sql := "DELETE FROM \"projectcards\" WHERE \"id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from projectcards")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for projectcards")
	}
...
func (q projectcardQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no projectcardQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from projectcards")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for projectcards")
	}
...
func (o ProjectcardSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"projectcards\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, projectcardPrimaryKeyColumns, len(o))
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from projectcard slice")
	}
...
func (o *ProjectcardSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in ProjectcardSlice")
	}
...
func ProjectcardExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"projectcards\" where \"id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if projectcards exists")
	}
